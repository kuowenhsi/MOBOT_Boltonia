...
glm_path <- "/Users/kuowenhsi/Library/CloudStorage/OneDrive-MissouriBotanicalGarden/General - IMLS National Leadership Grant 2023/Genotyping/Boltonia/alloutgroup/VCF_decurrens/FLMM_output/"
glm_input <- list.files("/Users/kuowenhsi/Library/CloudStorage/OneDrive-MissouriBotanicalGarden/General - IMLS National Leadership Grant 2023/Genotyping/Boltonia/alloutgroup/VCF_decurrens/FLMM_output")
length(glm_input)
...
for (i in 1:15){
  ...
  ggsave(paste0("./figures/LFMM_output/", str_remove(glm_input[[i]], ".txt"), ".png"), width = 10, height = 3.5, dpi = 600)
}
